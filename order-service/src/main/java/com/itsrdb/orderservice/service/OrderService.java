...
import com.itsrdb.orderservice.dto.InventoryResponse;
...
import com.itsrdb.orderservice.repository.OrderRepository;
    ...
    public void placeOrder(OrderRequest orderRequest){
        ...
        InventoryResponse[] inventoryResponseArray = webClient.get()
                .uri("http://localhost:8082/api/inventory",
                        // Passing a list of sku codes in format '?skuCode=iphone-15&skuCode=iphone-14'
                        uriBuilder -> uriBuilder.queryParam("skuCode", skuCodes).build())
                .retrieve()
                .bodyToMono(InventoryResponse[].class)
                .block();

        boolean areProductInStock = Arrays.stream(inventoryResponseArray)
